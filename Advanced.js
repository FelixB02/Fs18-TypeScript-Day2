...
class vehicle {
    constructor(picture, brand, model, numberOfSeats, kilometers, ps, price) {
...
class car extends vehicle {
    constructor(picture, brand, model, numberOfSeats, kilometers, ps, price, drivingassistent) {
...
let carsdisplay = document.getElementById("carbtn");
...
function loopCars() {
    ...
    let carinner = document.getElementById("Info");
    carinner.innerHTML = "";
...
class motorbike extends vehicle {
    constructor(picture, brand, model, numberOfSeats, kilometers, ps, price, cubicCapacity, helmincluded) {
        super(picture, brand, model, numberOfSeats, kilometers, ps, price);
...
let motorbikesdisplay = document.getElementById("motorbikebtn");
...
function loopMotorbikes() {
    ...
    let bikeinner = document.getElementById("Info");
    bikeinner.innerHTML = "";
    for (let i = 0; i < cars.length; i++) {
